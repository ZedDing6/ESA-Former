...
from modelapp import convnext_base as create_model
...
def run_once(args, run_id):
    ...
    logger = get_logger(
        f'/mnt/data/home/wangjialuo/code/ConvNeXt/convnextoapp_run{run_id}.log'
    )
    ...
    for epoch in range(args.epochs):
        ...
        if f1_va > best_f1:
            ...
            torch.save(
                model.state_dict(),
                f"./weights/convnextoappbest_run{run_id}.pth"
            )
    ...
    plt.legend()
    plt.savefig(f"convnextoapploss_run{run_id}.png")
    plt.close()
    ...
    if best_matrix is not None:
        ...
        plt.tight_layout()
        plt.savefig(f"convnextoapp_cm_run{run_id}.png")
        plt.close()
...
if __name__ == '__main__':
    ...
    # 写入最后一次 run 日志
    final_logger = get_logger('/mnt/data/home/wangjialuo/code/ConvNeXt/convnextoapp_run3.log')

...
def run_once(run_id, args):
    ...
    logger = get_logger(f'/mnt/data/home/wangjialuo/code/ResNet/tifres_run{run_id}.log')
    ...
    save_path = f'./weights/tifres_run{run_id}.pth'
    ...
    plt.tight_layout()
    plt.savefig(f'tifres_cm_run{run_id}.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig(f'tifres_loss_run{run_id}.png')
    plt.close()
...
if __name__ == '__main__':
    ...
    final_logger = get_logger(
        '/mnt/data/home/wangjialuo/code/ResNet/tifres_run3.log'
    )

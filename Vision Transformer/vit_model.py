...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=200, patch_size=16, in_c=3, embed_dim=768, norm_layer=None):
        super().__init__()
        ...
        self.SelfAttention = SelfAttention(embed_dim, 32)
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=200, patch_size=16, in_c=5, num_classes=1000,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.0, qkv_bias=True,
                 qk_scale=None, representation_size=None, distilled=False, drop_ratio=0.,
                 attn_drop_ratio=0., drop_path_ratio=0., embed_layer=PatchEmbed, norm_layer=None,
                 act_layer=None, pretrained_model_path=None):

...
from omodel import vit_base_patch16_224_in21k as create_model
...
def main(args):
    ...
    logger = get_logger('/mnt/data/home/wangjialuo/code/Vision-Trans/ovit.log')
    ...
    plt.savefig('oVitloss.png')  # 保存loss图为图片文件
    plt.show()  # 显示loss图

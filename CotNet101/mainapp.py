...
from Spec222 import TIFImageFolder
from utils import train_one_epoch, evaluate
from modelapp import cotnet101 as create_model
...
def run_once(args, run_id):
    ...
    logger = get_logger(
        f'/mnt/data/home/wangjialuo/code/CotNet101/cotoapp_run{run_id}.log'
    )
    ...
    for epoch in range(args.epochs):
        ...
        if f1_va > best_f1:
            ...
            torch.save(
                model.state_dict(),
                f"./weights/cotoappbest_run{run_id}.pth"
            )
    ...
    plt.legend()
    plt.savefig(f"cotoapploss_run{run_id}.png")
    plt.close()
    ...
    if best_matrix is not None:
        ...
        plt.tight_layout()
        plt.savefig(f"cotoapp_cm_run{run_id}.png")
        plt.close()

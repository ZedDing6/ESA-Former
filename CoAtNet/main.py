...
from model import coatnet_1 as create_model
...
def run_once(args, run_id):
    ...
    logger = get_logger(
        f'/mnt/data/home/wangjialuo/code/coatnet/coatotif_run{run_id}.log'
    )
    ...
    for epoch in range(args.epochs):
        ...
        if f1_va > best_f1:
            ...
            torch.save(
                model.state_dict(),
                f"./weights/coatotifbest_run{run_id}.pth"
            )
    ...
    plt.legend()
    plt.savefig(f"coatotifloss_run{run_id}.png")
    plt.close()
    ...
    if best_matrix is not None:
        ...
        plt.tight_layout()
        plt.savefig(f"coatotif_cm_run{run_id}.png")
        plt.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lrf', type=float, default=0.00005)
    ...
    # ===================== 写入最后一轮 log =====================
    final_logger = get_logger(f'/mnt/data/home/wangjialuo/code/coatnet/coatotif_run3.log')

...
from model import pvt_v2_b5 as create_model
...
def run_once(args, run_id):
    ...
    logger = get_logger(
        f'/mnt/data/home/wangjialuo/code/pvtv2b5/pvtv2b5test_run{run_id}.log'
    )
    ...
    for epoch in range(args.epochs):
        ...
        if f1_va > best_f1:
            ...
            torch.save(
                model.state_dict(),
                f"./weights/pvtv2b5testbest_run{run_id}.pth"
            )
    ...
    plt.legend()
    plt.savefig(f"pvtv2b5testloss_run{run_id}.png")
    plt.close()
    ...
    if best_matrix is not None:
        ...
        plt.tight_layout()
        plt.savefig(f"pvtv2b5test_cm_run{run_id}.png")
        plt.close()
...
if __name__ == '__main__':
    ...
    final_logger = get_logger('/mnt/data/home/wangjialuo/code/pvtv2b5/pvtv2b5test_run3.log')
